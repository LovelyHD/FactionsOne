...
public class TerritoryAccess implements JsonDeserializer<TerritoryAccess>, JsonSerializer<TerritoryAccess> {
    ...
    public boolean isDefault() {
        return hostFactionAllowed && factionIDs.isEmpty() && fplayerIDs.isEmpty();
    }
    ...
    public boolean subjectAccessIsRestricted(Object testSubject) {
        return !isHostFactionAllowed() && doesHostFactionMatch(testSubject) && !FPerm.ACCESS.has(testSubject, getHostFaction());
    }
    ...
    public boolean equals(Object obj) {
        ...
        return hostFactionID.equals(that.hostFactionID) && hostFactionAllowed == that.hostFactionAllowed && factionIDs == that.factionIDs && fplayerIDs == that.fplayerIDs;
    }
