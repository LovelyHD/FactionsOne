...
public class FactionsChatListener implements Listener {
     ...
     * however color is enabled we face a limitation in Bukkit. Bukkit does not support the same
     * message looking different for each recipient. The method we use to get around this is a bit
     * hacky: 1. We cancel the chat event on EventPriority.HIGHEST 2. We trigger
     * EventPriority.MONITOR manually without relation color. 3. We log in console the way it's
     * usually done (as in nms.NetServerHandler line~793). 4. We send out the messages to each
     * player with relation color. The side effect is that other plugins at EventPriority.HIGHEST
     * may experience the event as cancelled.
     */
    ...
    /**
     * This is some nasty woodo - I know :/ I should make a pull request to Bukkit and CraftBukkit
