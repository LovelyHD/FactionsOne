...
public class CmdHome extends FCommand {
    ...
    public void perform() {
        ...
        if (Conf.homesTeleportAllowedEnemyDistance > 0 && faction.getFlag(FFlag.PVP) && (!fme.isInOwnTerritory() || fme.isInOwnTerritory() && !Conf.homesTeleportIgnoreEnemiesIfInOwnTerritory)) {
